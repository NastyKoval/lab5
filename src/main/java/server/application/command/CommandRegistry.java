...
public class CommandRegistry {
    ...
    private void registerAllCommands() {
        ...
        commandMap.put("count_less_than_number_of_bathrooms",
                new CountLessThanBathroomsRequest(0L));
        commandMap.put("filter_greater_than_house",
                new FilterGreaterThanHouseRequest(null));
        commandMap.put("print_field_descending_furnish",
                new PrintFieldDescendingFurnishRequest());
